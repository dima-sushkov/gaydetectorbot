...
const yearTeasePhrases = [
    [
        ...
        "Да чё тут искать, если честно. Всё видно невооружённым глазом.",
        "Главный пидор года давно известен. И он это знает:",
    ],
    [
    ...
    [
        ...
        "Эксперты совещались ровно 0.3 секунды. Единогласно.",
        "Жюри согласно. Зрители согласны. Даже он сам, наверное, согласен:",
    ],
    [
...
const autoYearTeasePhrases = [
    [
        ...
        "Статистика собрана, позор задокументирован.",
        "Запускаю годовую пробивку. Смотрим кто засветился больше всех:",
    ],
    [
        "31 декабря. Время подводить итоги.",
        "Год прошёл, имена записаны, ничего не забыто.",
        "Пробивка по итогам года запущена. Смотрим:",
    ],
    [
        "Последний день года. Все данные подняты.",
        "Картина ясная. Один человек старался весь год.",
...
const yearWinnerPhrases = [
    ...
    "Год прошёл. Главный петух среди нас, и это — ",
    "Орден «Пидор Года» первой степени торжественно вручается — ",
