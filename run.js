...
📊 **Статистика** — веду учёт кто сколько раз попался. Топ, архив по годам, всё дела.

🔥 **Стрики** — если кто-то попадается несколько дней подряд — комментирую это отдельно и тегаю всех участников при 3+ днях подряд.

🎄 **Итоги года** — 31 декабря автоматически объявляю главного пидора года и сбрасываю статистику.

📰 **Итоги недели** — каждое воскресенье в 20:00 по Киеву пишу смешной репортаж о прошедшей неделе.

🤖 **AI агент** — тегни меня в чате и я отвечу. Понимаю что ты хочешь и могу запускать команды голосом.");
